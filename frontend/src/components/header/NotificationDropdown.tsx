...
export default function NotificationDropdown() {
  ...
  useEffect(() => {
    apiRequest<Notification[]>("/club/notifications/")
      .then(setNotifications)
      .catch(() => setNotifications([]));
  }, []);

  const hasUnread = notifications.some((n) => !n.is_seen);
  ...
  return (
    <div className="relative">
      ...
      <Dropdown
        ...
        className="absolute -right-[240px] mt-[17px] flex h-[480px] w-[350px] flex-col rounded-2xl border border-gray-200 bg-white p-3 font-ui shadow-theme-lg dark:border-gray-800 dark:bg-gray-dark sm:w-[361px] lg:right-0"
      >
        <div className="flex items-center justify-between pb-3 mb-3 border-b border-gray-100 dark:border-gray-700">
          <h5 className="font-heading text-lg text-gray-800 dark:text-gray-200">
            Notificações
          </h5>
          <button
            onClick={toggleDropdown}
